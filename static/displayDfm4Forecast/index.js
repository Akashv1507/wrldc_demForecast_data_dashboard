...
$('#displayDfm4Forecast thead tr').clone(true).appendTo('#displayDfm4Forecast thead');
$('#displayDfm4Forecast thead tr:eq(1) th').each(function(i) {
    var title = $(this).text();
...
$(document).ready(function() {
    table = $('#displayDfm4Forecast').DataTable({
        dom: 'Bfrtip',
